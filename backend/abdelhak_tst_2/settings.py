"""
Django settings for abdelhak_tst_2 project.
...
ROOT_URLCONF = 'abdelhak_tst_2.urls'
...
WSGI_APPLICATION = 'abdelhak_tst_2.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Abdelhak TST Support <support@abdelhak-tst-2.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "abdelhak_tst_2 API",
    "DESCRIPTION": "API documentation for abdelhak_tst_2 App",
    "VERSION": "v1",
}
